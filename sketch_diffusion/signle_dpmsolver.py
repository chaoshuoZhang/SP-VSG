            ...
            if method == 'adaptive':
                ...
                for step in tqdm(range(order, steps + 1)):
                    ...
                    if step < steps:
                        ...
                        #out = self.diffusion.ddim_sample(self.model, x, torch.tensor([0]*x.shape[0], device=t.device))  # torch.tensor([0]*x.shape[0], device=t.device))
                        #x, pen_state = out['sample'], out['pen_state']
